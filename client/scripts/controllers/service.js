 ...
 */
 angular.module("appDonateApp")
  .constant("baseURL",
          "http://localhost:5000/")  //"https://donatelife.herokuapp.com/")
 .factory("mydonorFactory", ["$resource", "baseURL", function ($resource, baseURL) {

        return $resource(baseURL + "mydonor/:id", null, {
            "update": {
                method: "PUT"
            },
...
.factory("needFactory", ["$resource", "baseURL", function ($resource, baseURL) {
        ...
        return $resource(baseURL + "servs/:id", null, {
            "update": {
                method: "PUT"
            }
        });
